    ...
    return [
      css`
        :host {
          ...
          --app-header-background-color: #d87900;
    ...
    return html`
      ...
      <app-drawer .opened="${this._drawerOpened}" .persistent="${this._wideLayout}"
        ...
        <nav class="drawer-list">
          <a ?selected="${this._page === 'view1'}" href="/view1">Início</a>
          <a ?selected="${this._page === 'view2'}" href="/view2">Notícias</a>
          <a ?selected="${this._page === 'view3'}" href="/view3">Eventos</a>
        </nav>
      </app-drawer>
